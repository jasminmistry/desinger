...
class StoreDigitizingRequest extends FormRequest
{
    /**
    ...
    public function rules(): array
    {
        return [
            ...
            'febric_type' => 'required|string|max:255',
            'no_of_colors' => 'required|numeric|max:100',
            'febric_color' => 'required|string|max:255',
            'thread_type' => 'required|string|max:255',
            'background_filled' => 'required|string|max:255',
            'picture' => 'required',
