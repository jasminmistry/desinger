              ...
              <div class="mt-3 text-center sm:ml-4 sm:mt-0 sm:text-left">
                ...
                <div class="mt-2 grid grid-cols-2 gap-4">
                    ...
                    <div class="col-span-2 lg:col-span-1 flex flex-col gap-2">
                        ...
                        <div class="flex-1 w-full">
                            <x-text-input id="additional_instruction" type="text" name="additional_instruction" :value="old('additional_instruction', $preference->vc_additional_instruction ?? '')" required
                                autofocus />
                    ...
                    <div class="col-span-2 lg:col-span-1 flex flex-col gap-2">
                        ...
                        <div class="flex-1 w-full">
                            <x-text-input id="instructions" type="text" name="instructions"
                                :value="old('instructions', $preference->vc_instructions ?? '')" required autofocus />
